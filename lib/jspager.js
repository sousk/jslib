...
jsPager.prototype = {
  ...
  set_params: function(params) {
    ...
    this.column_numbers = this.gen_column_numbers();
    return this;
  },
  ...
  update_page_columns: function() {
    ...
    this.get('cols').each(function(i, page) {
      ...
      var updated = updator($(page), pnum, pnum, pnum != that.page.current);      
    });
